...
func (d *dummySDAPIBinary) PostCommand(specPath string, smallSpec *util.CommandSpec) (string, error) {
	return "", nil
}
...
func (d *dummySDAPIBroken) PostCommand(specPath string, smallSpec *util.CommandSpec) (string, error) {
